...
namespace PostalService.Controllers
{
    public class ServiceController
	{
		...
		// таблица сведений о секторах
		public List<Sector> GetSectors() => _postalDb.Sectors.ToList();

		// таблица сведений о представлении почтальонах
		public List<PostmansAddView> GetPostmansAddView() => _postalDb.PostmansAddViews.ToList();

		// таблица сведений о представлении подписок
		public List<PublicationsAddView> GetPublicationsAddView() => _postalDb.PublicationsAddViews.ToList();
